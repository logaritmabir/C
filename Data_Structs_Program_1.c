...
int main(void)
{
    ...
    IndexToBeDeleted(10,Indexes);       //4-Sil fonksiyonu ile herhangi bir indeksli öğrencinin notunun silinmesi
    ...
    PrintGrade(60,StudentList,Indexes);         //İstenilen notdan yüksek olan notların index sırasına göre yazdırılması
}
